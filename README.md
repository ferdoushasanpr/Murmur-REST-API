...
1\. \*\*Users\*\*: Stores profiles, hashed credentials, and counters.

2\. \*\*Murmurs\*\*: Stores post content and a reference to the author.

3\. \*\*Follows\*\*: A junction collection managing the "Following" relationship between User IDs.
...
MONGO\_URI=mongodb+srv://<user>:<password>@cluster.mongodb.net/murmur

JWT\_SECRET=your\_super\_secret\_string\_here
